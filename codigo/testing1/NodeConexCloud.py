...
TOPIC = "/v1.6/devices/prueba-stream-processing-testing"
        ...
        if event == FAIL_CONEX:
            ...
            for i in range(0, N_PIPELINES):
                ...
                if message.topic == topic:
                    ...
                    key_N_PACKAGE = STR_N_PIPELINE + "-ITERATOR_TEST-" + "N_PACKAGE" 
                    key_ITERATOR = STR_N_PIPELINE + "-ITERATOR_TEST-" + "ITERATOR" 

                    Dict = {
                    key_N_PACKAGE: int(n_package),   
